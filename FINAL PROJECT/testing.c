...
//     engineer[0] = 15;         // phaser
//     engineer[1] = 20;          // crowbar
...
//     gunslinger[0] = 20;         // phaser
//     gunslinger[1] = 15;          // crowbar
...
//         int random_int_crowbar(int n);
//         int random_int_phaser(int n);
//         srand(time(NULL));
...
//         if(attack_move == 1) {
//             alien_attk = random_int(10);
//             big_ass_alien = big_ass_alien - alien_attk;
...
//             alien_attk = random_int_crowbar(10);
//             big_ass_alien = big_ass_alien - alien_attk;
//             printf("\nYou swing your crowbar! Damage >> %i\n\n", alien_attk);
//             if(big_ass_alien < 0) {
//                 printf("You have killed the Big Ass Alien you win!\n\n");
//                 break;
//             }
//             printf("Big Ass Alien's HP >>  %i\n\n", big_ass_alien);
...
//     printf("Uploading USS Ozark blueprints into your neural database. Give me a moment...\n");
...
//     printf("\n");
//     type_text("I need you to locate the engine bay and place the fusion cores into the main nuclear reactors. Once that is complete, I will be able to power our defense systems and locate unknown terrestrials aboard this fleet.\n", 40);
//     printf("\n\n");
...
void location() {
    ...
    int i = 0;
    do {
        printf("Enter the location you would like to go >>> ");
        scanf("%d", &loc_num);
